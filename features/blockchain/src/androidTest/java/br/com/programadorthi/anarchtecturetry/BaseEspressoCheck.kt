@file:JvmName("BaseEspressoCheck")
...
fun ViewInteraction.isNotDisplayed(): ViewInteraction = this.check(matches(not(ViewMatchers.isDisplayed())))

fun ViewInteraction.isNotEnabled(): ViewInteraction = this.check(matches(not(ViewMatchers.isEnabled())))
...
fun ViewInteraction.clickButton(@IdRes resId: Int): ViewInteraction = this.perform(ViewActions.click())
